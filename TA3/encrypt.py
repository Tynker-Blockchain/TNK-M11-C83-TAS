...
# Define encrypt function that takes message and publicKey as parameters
def encrypt(message, publicKey):
    # Get publicExponent and modulus from publicKey
    publicExponent, modulus = publicKey
    # Use formula [(ord(char) ** publicExponent) % modulus for char in message] and store the results in 'ciphertext' variable
